...
> crate::models::Evaluation get_evaluation(eval_id, region, namespace, index, wait, stale, prefix, x_nomad_token, per_page, next_token)
...
> Vec<crate::models::AllocationListStub> get_evaluation_allocations(eval_id, region, namespace, index, wait, stale, prefix, x_nomad_token, per_page, next_token)
...
> Vec<crate::models::Evaluation> get_evaluations(region, namespace, index, wait, stale, prefix, x_nomad_token, per_page, next_token)
