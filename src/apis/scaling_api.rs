...
#[serde(untagged)]
pub enum GetScalingPoliciesError {
    Status400(),
    Status403(),
    Status405(),
    Status500(),
...
/// struct for typed errors of method `get_scaling_policy`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetScalingPolicyError {
    Status400(),
    Status403(),
    Status405(),
    Status500(),
...
pub async fn get_scaling_policies(configuration: &configuration::Configuration, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Result<Vec<crate::models::ScalingPolicyListStub>, Error<GetScalingPoliciesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scaling/policies", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetScalingPoliciesError> = serde_json::from_str(&local_var_content).ok();
...
#[allow(clippy::too_many_arguments)]
pub async fn get_scaling_policy(configuration: &configuration::Configuration, policy_id: &str, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Result<crate::models::ScalingPolicy, Error<GetScalingPolicyError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/scaling/policy/{policyID}", configuration.base_path, policyID=crate::apis::urlencode(policy_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetScalingPolicyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
